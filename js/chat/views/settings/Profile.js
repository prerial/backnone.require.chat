define([
    ...
    'underscore',
    'application',
    'chat/views/settings/EditProfile',
    'text!chat/templates/settings/profile.html'
    ...
    return Backbone.View.extend({
        ...
        showProfileSection: function (evt) {
            ...
            window.setTimeout(function () {
                App.chat.scrolls.Country = new iScroll('countryScroll');
            },500)
        },
        goBack: function () {
            App.chat.displaySlider.slide(4);
            App.chat.scrolls.Country.destroy();
            App.chat.scrolls.Country = null;
        },
        initialize: function () {
